...
<html>
	<head>
		...
		<title><xsl:value-of select="/squad/name"/> Squad-XML</title>
	...
	<body>
        <header>
            <a>
                ...
                <img src="adlerkopp.svg" />
                <h3><xsl:value-of select="/squad/name"/></h3>
            </a>
        </header>
        <main class="members">
            <xsl:for-each select="/squad/member">
                <div class="member">
                    <img class="member__avatar" src="adlerkopp.svg" />
                    <span class="member__nick" ><xsl:value-of select="@nick"/></span>
                    <div class="member__contact">
                        ...
                        <a target="_blank">
                            <xsl:attribute name="href">https://steamcommunity.com/profiles/<xsl:value-of select="@id"/></xsl:attribute>
                            <img>
        ...
        <footer>
            <address>
                ...
                Contact:
                <a>
                    <xsl:attribute name="href"><xsl:value-of select="/squad/email"/></xsl:attribute>
